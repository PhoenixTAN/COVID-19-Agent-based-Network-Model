...
const static int NUM_OF_SOCIAL_EACH_HOUR = 50;
...
static int INITIAL_NUM_OF_PRESYMTOMATIC = std::max(10, NETWORK_SIZE / 1000);
...
/* Asymptomatic */
const static int MAX_ASYMPTOMATIC_PERIOD = 12;       // days
const static int MIN_ASYMPTOMATIC_PEROID = 4;


/* after this period, agent will have a high probability to get severe */
const static int MAX_MILD_PERIOD = 8;       // days
const static int MIN_MILD_PERIOD = 3;       // days
const static float MILD_TO_SEVERE = 0.6;

/* after this period, agent will have a high period to die */
const static int MAX_SEVERE_PERIOD = 8;     // days
const static int MIN_SEVERE_PERIOD = 3;   // days
